...
module.exports = {
    ...
    query: ( longitude, latitude, outputProjection = "EPSG:4326" ) => {
        return new Promise(( resolve, reject ) => {
            ...
            //const cmd = "gdallocationinfo ./data/GMTED2010/" + tile.file + " -wgs84 " + longitude + " " + latitude;
            exec( cmd, ( err, stdout, stderr ) => {
                ...
                return resolve( !isNaN( Number( splittedAltitudeValue ) ) ? Number( splittedAltitudeValue ) : null );
            });
        });
    },
